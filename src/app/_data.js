...
export const langData = {
  ...
  start: {
    ...
    info: {
      ru: 'Сыграй и проверь свои знания о птицах!!!',
      en: 'Play and test your knowledge about birds!!!',
    },
    button: {
      ru: 'Играть',
      en: 'Play',
  ...
  game: {
    ...
    descStab: {
      ru: 'Прослушайте запись и угадайте птицу по звуку.',
      en: 'Listen to the recording and guess the bird by the sound.',
    },
  ...
  results: {
    ...
    emptyMessage: {
      ru: 'Пройдите игру и увидите здесь свои результаты.',
      en: 'Complete the game and see your results here.',
    },
    someTitle: {
      ru: 'Игра пройдена',
      en: 'Game completed',
    ...
    someMessage: {
      ru: (p) =>
        `Ваш результат ${p} из 25 максимально возможных баллов. Вы можете лучше.`,
      en: (p) =>
        `Your result is ${p} out of 25 maximum possible points. You can do better.`,
    },
    maxTitle: {
      ru: 'Поздравляем!!!',
      en: 'Congratulations!!!',
    ...
    maxMessage: {
      ru: (p) =>
        `Ваш результат ${p} из 25 максимально возможных баллов. Вы знаете все о птицах!`,
      en: (p) =>
        `Your score is ${p} out of the maximum 25 possible points. You know all about birds!`,
    },
    button: {
      ru: 'Играть еще',
      en: 'Play again',
